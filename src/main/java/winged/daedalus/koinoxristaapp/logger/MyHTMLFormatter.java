package winged.daedalus.koinoxristaapp.logger;
...
/**
 * Created by TeoGia<teogia89@gmail.com> on Jul 8, 2015
 */
  ...
  // this method is called just after the handler using this formatter is created
	public String getHead(Handler h) {
		...
		return "<!DOCTYPE html>\n<head>\n<style>\n"
				...
				+ "<tr align=\"left\">\n"
				+ "\t<th style=\"width:7%\">Loglevel</th>\n"
				+ "\t<th style=\"width:15%\">Time</th>\n"
				+ "\t<th style=\"width:20%\">Logger's Name</th>\n"
				+ "\t<th style=\"width:58%\">Log Message</th>\n"
				+ "</tr>\n";
	}
